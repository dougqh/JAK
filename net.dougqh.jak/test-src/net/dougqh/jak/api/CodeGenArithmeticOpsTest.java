...
public final class CodeGenArithmeticOpsTest {
	...
	public final @Test void intOps() {
		TestClassLoader classLoader = new TestClassLoader( CLASS_LOADER, "IntOps" ) {
			...
			private /* static */ final JavaCodeWriter constMethod(
			...
			private /* static */ final JavaCodeWriter unaryMethod(
				final JavaClassWriter classWriter,
				final String name )
			{
				return classWriter.define(
			...
			private /* static */ final JavaCodeWriter binaryMethod(
				final JavaClassWriter classWriter,
				final String name )
			{
				return classWriter.define(
	...
	public final @Test void longOps() {
		TestClassLoader classLoader = new TestClassLoader( CLASS_LOADER, "LongOps" ) {			
			...
			private /* static */ final JavaCodeWriter shiftMethod(
				final JavaClassWriter classWriter,
				final String name )
			{
				return classWriter.define(
