...
final class FormalArguments implements Iterable< JavaVariable > {
	static final FormalArguments EMPTY = new FormalArguments();
	
	private final JavaVariable[] arguments;
	
	static final FormalArguments instance( final Type... argumentTypes ) {
	...
	static final FormalArguments instance( final JavaVariable... arguments ) {
	...
	static final FormalArguments instance(
