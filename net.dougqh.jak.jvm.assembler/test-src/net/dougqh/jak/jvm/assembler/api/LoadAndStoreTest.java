...
public final class LoadAndStoreTest {
	...
	public final @Test void intSlotZero() {
		JvmClassWriter classWriter = new JvmWriter().define( public_().final_().class_( "Int" ) );
	...
	public final @Test void floatSlotZero() {
		JvmClassWriter classWriter = new JvmWriter().define( public_().final_().class_( "Float" ) );
	...
	public final @Test void longSlotZero() {
		JvmClassWriter classWriter = new JvmWriter().define( public_().final_().class_( "Long" ) );
	...
	public final @Test void doubleSlotZero() {
		JvmClassWriter classWriter = new JvmWriter().define( public_().final_().class_( "Double" ) );
	...
	public final @Test void objectSlotZero() {
		JvmClassWriter classWriter = new JvmWriter().define( public_().final_().class_( "Object" ) );
